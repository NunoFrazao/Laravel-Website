		...
		<?php if( get_theme_mod( 'multipurpose_ecommerce_date_hide',true) != '' || get_theme_mod( 'multipurpose_ecommerce_comment_hide',true) != '' || get_theme_mod( 'multipurpose_ecommerce_author_hide',true) != '') { ?>
			<div class="post-info">
				<?php if( get_theme_mod( 'multipurpose_ecommerce_date_hide',true) != '') { ?>
				  <i class="fa fa-calendar"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $archive_year, $archive_month, $archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><?php echo esc_html( get_theme_mod('multipurpose_ecommerce_seperator_metabox') ); ?>
				<?php } ?>
				<?php if( get_theme_mod( 'multipurpose_ecommerce_author_hide',true) != '') { ?>
				  <i class="fa fa-user"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><?php echo esc_html( get_theme_mod('multipurpose_ecommerce_seperator_metabox') ); ?>
				<?php } ?>
